...
@_CS136_TOOLS_SNOOP_MESSAGE = constant [213 x i8] c"GREETINGS to all students trying to snoop through the .ll file. You may be here out of curiosity (that's fine) or you might be trying to reverse-engineer what we are doing (please don't). With lots of love, Dave.\00", align 16
@READ_INT_FAIL = constant i32 -2147483648, align 4
@READ_CHAR_FAIL = constant i8 0, align 1
@READ_WHITESPACE = constant i8 0, align 1
@IGNORE_WHITESPACE = constant i8 1, align 1
@INVALID_SYMBOL = constant i32 0, align 4
@_tracing_out = internal global %struct._IO_FILE* null, align 8
@stderr = external global %struct._IO_FILE*, align 8
@.str = private unnamed_addr constant [28 x i8] c">>> cs136tools version 1.5\0A\00", align 1
...
@.str.24 = private unnamed_addr constant [4 x i8] c"ptr\00", align 1
@.str.25 = private unnamed_addr constant [3 x i8] c"%p\00", align 1
@.str.26 = private unnamed_addr constant [19 x i8] c"INVALID TYPE: %s]\0A\00", align 1
...
if.end:                                           ; preds = %if.then, %entry
  %2 = load i8, i8* @TRACE_FLAG, align 1
  %tobool1 = trunc i8 %2 to i1
  br i1 %tobool1, label %if.then2, label %if.end70
...
if.else:                                          ; preds = %if.then2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.9, i64 0, i64 0), i32 72, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i64 0, i64 0)) #8
  unreachable
...
if.else7:                                         ; preds = %if.end4
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.9, i64 0, i64 0), i32 73, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i64 0, i64 0)) #8
  unreachable

if.end8:                                          ; preds = %if.then6
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %6 = load i8*, i8** %filename.addr, align 8
  %call = call i8* @strchr(i8* %6, i32 47) #7
  %tobool9 = icmp ne i8* %call, null
  br i1 %tobool9, label %cond.true, label %cond.false

cond.true:                                        ; preds = %if.end8
  %7 = load i8*, i8** %filename.addr, align 8
  %call10 = call i8* @strrchr(i8* %7, i32 47) #7
...
if.end17:                                         ; preds = %if.then15, %for.body
  ...
  %call18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i64 0, i64 0)) #7
...
if.else22:                                        ; preds = %if.end17
  ...
  %call23 = call i32 @strcmp(i8* %23, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.15, i64 0, i64 0)) #7
...
if.else29:                                        ; preds = %if.else22
  ...
  %call30 = call i32 @strcmp(i8* %28, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i64 0, i64 0)) #7
...
if.else36:                                        ; preds = %if.else29
  ...
  %call37 = call i32 @strcmp(i8* %34, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19, i64 0, i64 0)) #7
...
if.else46:                                        ; preds = %if.else36
  ...
  %call47 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.23, i64 0, i64 0)) #7
...
if.else54:                                        ; preds = %if.else46
  ...
  %call55 = call i32 @strcmp(i8* %46, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.24, i64 0, i64 0)) #7
  %tobool56 = icmp ne i32 %call55, 0
  br i1 %tobool56, label %if.else61, label %if.then57

if.then57:                                        ; preds = %if.else54
  %47 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %48 = load i8*, i8** %trace_array_ptr.addr, align 8
  %49 = bitcast i8* %48 to i8**
  %50 = load i32, i32* %i, align 4
  %idxprom58 = sext i32 %50 to i64
  %arrayidx59 = getelementptr inbounds i8*, i8** %49, i64 %idxprom58
  %51 = load i8*, i8** %arrayidx59, align 8
  %call60 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.25, i64 0, i64 0), i8* %51)
  br label %if.end63

if.else61:                                        ; preds = %if.else54
  %52 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %53 = load i8*, i8** %type.addr, align 8
  %call62 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %52, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.26, i64 0, i64 0), i8* %53)
  br label %if.end70
...
for.end:                                          ; preds = %for.cond
  %55 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %call69 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %55, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.27, i64 0, i64 0))
  br label %if.end70

if.end70:                                         ; preds = %if.else61, %for.end, %if.end
  ret void
}
...
; Function Attrs: noinline nounwind optnone
define void @_TRACE_PRINTF(i8* %filename, i8* %funcname, i32 %lineno, i8* %fstr, ...) #0 {
entry:
  %filename.addr = alloca i8*, align 8
  %funcname.addr = alloca i8*, align 8
  %lineno.addr = alloca i32, align 4
  %fstr.addr = alloca i8*, align 8
  %args = alloca [1 x %struct.__va_list_tag], align 16
  store i8* %filename, i8** %filename.addr, align 8
  store i8* %funcname, i8** %funcname.addr, align 8
  store i32 %lineno, i32* %lineno.addr, align 4
  store i8* %fstr, i8** %fstr.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %tobool = icmp ne %struct._IO_FILE* %0, null
  br i1 %tobool, label %if.end, label %if.then
...
if.then2:                                         ; preds = %if.end
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %4 = load i8*, i8** %filename.addr, align 8
  %call = call i8* @strchr(i8* %4, i32 47) #7
  %tobool3 = icmp ne i8* %call, null
  br i1 %tobool3, label %cond.true, label %cond.false
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %10 = load i8*, i8** %fstr.addr, align 8
  %arraydecay7 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %args, i64 0, i64 0
  %call8 = call i32 @vfprintf(%struct._IO_FILE* %9, i8* %10, %struct.__va_list_tag* %arraydecay7)
  ...
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @_tracing_out, align 8
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.28, i64 0, i64 0))
  br label %if.end12
...
; Function Attrs: noinline nounwind optnone
define signext i8 @read_char(i1 zeroext %ws_behaviour) #0 {
entry:
  %retval = alloca i8, align 1
  %ws_behaviour.addr = alloca i8, align 1
  %c = alloca i8, align 1
  %result = alloca i32, align 4
  %frombool = zext i1 %ws_behaviour to i8
  store i8 %frombool, i8* %ws_behaviour.addr, align 1
  store i8 0, i8* %c, align 1
  %0 = load i8, i8* %ws_behaviour.addr, align 1
  %tobool = trunc i8 %0 to i1
  %conv = zext i1 %tobool to i32
  %cmp = icmp eq i32 %conv, 1
  %1 = zext i1 %cmp to i64
  %cond = select i1 %cmp, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.29, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.16, i64 0, i64 0)
...
if.end5:                                          ; preds = %if.end
  ...
  %call7 = call i32 @toupper(i32 %conv6) #7
...
lor.lhs.false:                                    ; preds = %if.end5
  ...
  %call12 = call i32 @toupper(i32 %conv11) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %call21 = call i32 @toupper(i32 %conv20) #7
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call27 = call i32 @toupper(i32 %conv26) #7
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [256 x [64 x i8]], [256 x [64 x i8]]* bitcast (<{ [64 x i8], [255 x [64 x i8]] }>* @_symbol_table to [256 x [64 x i8]]*), i64 0, i64 %idxprom
  %arraydecay = getelementptr inbounds [64 x i8], [64 x i8]* %arrayidx, i64 0, i64 0
  %call = call i32 @strcmp(i8* %2, i8* %arraydecay) #7
...
if.end3:                                          ; preds = %for.end
  ...
  %9 = load i8*, i8** %s.addr, align 8
  %call8 = call i8* @strcpy(i8* %arraydecay7, i8* %9) #4
...
entry:
  ...
  %len = alloca i32, align 4
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.29, i64 0, i64 0), i8* getelementptr inbounds ([64 x i8], [64 x i8]* @_symbol_buffer, i64 0, i64 0))
...
attributes #5 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-features"="+cx8,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
